...
![](/img/dso-slam-trackNewCorase.png){:height="180px" width="180px"}

###Initializer
CoarseInitializer中使用了类似CoarseTracker中的跟踪方法，使用trackerframe完成点的匹配和点的建立。如图所示![](/img/dso-slam-Initilizer.png){:height="180px" width="180px"}
